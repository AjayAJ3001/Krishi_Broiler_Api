...
exports.addDC = async (req, res) => {
    ...
    try {
        ...
        while (!isUnique) {
            ...
            //     jsonb_set(
            //         loc_doc_count.next_number,
            //         ARRAY[$2],
            //         ((loc_doc_count.next_number->>$2)::int + 1)::text::jsonb
            //     )
            ...
            final_doc_no = isTaxable ? `DC/${loc_str}GT/${seqStr}` : `DC/${loc_str}GE/${seqStr}`;
            final_token_no = `${tokenPrefix}${seqStr}`;
    ...
    try {
        ...
        if (isEwayBill) {
            ...
            invoicePayload = {
                ...
                "transactionType": 1,
                "otherValue": 0,
                "totalValue": Math.round(Number(finalMaterials[0].basic)),
